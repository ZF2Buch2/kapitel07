...
Die Projektdateien für das Kapitel 07 vom Buch **Zend Framework 2 - Von den 
...
* Sie können die Projektdateien als ZIP von der Website http://www.awl.de/2994 
  unter Downloads oder von GitHub https://github.com/ZF2Buch/kapitel07 herunter
  laden und in einem geeigneten Verzeichnis entpacken, z.B.
```
  /home/devhost/zf2buch/kapitel07
```
...
```
    ...
    $ git clone https://github.com/ZF2Buch/kapitel07.git
    $ cd kapitel07/
```
...
```
    <VirtualHost *>
      ...
      DocumentRoot /home/devhost/zf2buch/kapitel07/public/
      AccessFileName .htaccess
      <Directory /home/devhost/zf2buch/kapitel07/public/>
