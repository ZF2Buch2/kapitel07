...
Die Projektdateien für das Kapitel 07 vom Buch **Zend Framework 2 - Das
Praxisbuch** (*ISBN 978-3-8362-2610-3*) von Ralf Eggert 
aus dem Galileo-Computing Verlag installieren Sie wie folgt:

* Sie können die Projektdateien von https://github.com/ZF2Buch2/kapitel07 als  
...
```
    ...
    $ git clone https://github.com/ZF2Buch2/kapitel07.git
    $ cd kapitel07/
```
